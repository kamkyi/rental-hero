...
const resources = {
  en: {
    translation: {
      ...
      login: "Login",
      logout: "Logout",
      authOpeningLogin: "Opening secure sign in...",
      authSigningOut: "Signing you out...",
      authLoginSuccess: "You are signed in.",
      authLogoutSuccess: "You are signed out.",
      authLoginError: "We couldn't open sign in. Please try again.",
      authLogoutError: "We couldn't sign you out. Please try again.",
      authSyncingAccount: "Syncing account...",
  ...
  my: {
    translation: {
      ...
      authOpeningLogin: "လုံခြုံသော အကောင့်ဝင်စာမျက်နှာကို ဖွင့်နေသည်...",
      authSigningOut: "သင့်အကောင့်ကို ထွက်နေသည်...",
      authLoginSuccess: "အကောင့်ဝင်ပြီးပါပြီ။",
      authLogoutSuccess: "အကောင့်ထွက်ပြီးပါပြီ။",
      authLoginError: "အကောင့်ဝင်စာမျက်နှာကို ဖွင့်မရပါ။ ထပ်မံကြိုးစားပါ။",
      authLogoutError: "အကောင့်ထွက်မရပါ။ ထပ်မံကြိုးစားပါ။",
      authSyncingAccount: "အကောင့်ကို စင့်ခ်လုပ်နေသည်...",
      accountShortcuts: "အကောင့် အမြန်လုပ်ဆောင်မှုများ",
      location: "တည်နေရာ",
      language: "ဘာသာစကား",
      languageNames: {
        en: "အင်္ဂလိပ်",
  ...
  th: {
    translation: {
      ...
      login: "เข้าสู่ระบบ",
      logout: "ออกจากระบบ",
      authOpeningLogin: "กำลังเปิดหน้าลงชื่อเข้าใช้อย่างปลอดภัย...",
      authSigningOut: "กำลังออกจากระบบ...",
      authLoginSuccess: "ลงชื่อเข้าใช้แล้ว",
      authLogoutSuccess: "ออกจากระบบแล้ว",
      authLoginError: "ไม่สามารถเปิดหน้าลงชื่อเข้าใช้ได้ กรุณาลองอีกครั้ง",
      authLogoutError: "ไม่สามารถออกจากระบบได้ กรุณาลองอีกครั้ง",
      authSyncingAccount: "กำลังซิงก์บัญชี...",
      accountShortcuts: "ทางลัดบัญชี",
      location: "สถานที่",
      language: "ภาษา",
      languageNames: {
        en: "อังกฤษ",
