...
export const carTypes: Array<'All' | CarType> = ['All', 'SUV', 'Sedan', 'Luxury', 'Electric', 'Van'];
...
export const cars: Car[] = [
  {
    ...
    description: 'A premium SUV built for airport pickups, business trips, and comfortable long drives across the city.',
  ...
  },
  {
    ...
    description: 'An efficient city sedan that is easy to park, easy on fuel, and ideal for urban day trips.',
  ...
  },
  {
    ...
    description: 'A clean, quiet electric drive with fast acceleration and a minimalist cabin for island travel.',
  ...
  },
  {
    ...
    description: 'A spacious SUV for family travel, beach routes, and weekend trips with extra luggage.',
  ...
  },
  {
    ...
    description: 'A practical hybrid SUV with smooth ride quality and enough room for business or family travel.',
  ...
  },
  {
    ...
    description: 'A high-capacity van for group transfers, wedding runs, or mountain trips with a driver add-on.',
